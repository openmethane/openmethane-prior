...
def test_units_kg_to_period_cell_flux(params, input_files):
    assert params.domain.grid.cell_area == 100000000.0
    assert (params.end_date - params.start_date).days + 1 == 2

    assert kg_to_period_cell_flux(60000, params) == 3.4722222222222217e-09
