...
def test_009_prior_emissions_ds(prior_emissions_ds):
    assert dataset_metrics(prior_emissions_ds) == {
        'max': {
            'LANDMASK': 1.0,
            'OCH4_TOTAL': 8.06788655272001e-09,
            'ch4_sector_agriculture': 1.3352720426101693e-12,
            ...
            'ch4_sector_stationary': 1.4004164091776333e-11,
            'ch4_sector_termite': 3.3858020553889645e-12,
            'ch4_sector_transport': 2.0714365427419788e-12,
            'ch4_sector_waste': 3.5799677996713788e-12,
            'ch4_sector_wetlands': 2.5512281176531815e-10,
            'ch4_total': 8.06788655272001e-09,
            'lambert_conformal': 0,
            'land_mask': 1,
        ...
        'mean': {
            'LANDMASK': 1.0,
            'OCH4_TOTAL': 5.629609410333118e-10,
            'ch4_sector_agriculture': 1.0658044918424546e-12,
            ...
            'ch4_sector_transport': 2.0688601291316032e-13,
            'ch4_sector_waste': 5.929320471032546e-14,
            'ch4_sector_wetlands': 1.2524275273123607e-10,
            'ch4_total': 5.629609410333118e-10,
        ...
        'x_band': {
            'LANDMASK': 10.0,
            'OCH4_TOTAL': 5.080394321335455e-09,
            'ch4_sector_agriculture': 2.4482132463182604e-11,
            ...
            'ch4_sector_oil_gas': 0.0,
            'ch4_sector_stationary': 2.6144589927557557e-11,
            'ch4_sector_termite': 4.7307820855158056e-11,
            'ch4_sector_transport': 3.8671968291737685e-12,
            'ch4_sector_waste': 0.0,
            'ch4_sector_wetlands': 1.3007149732291445e-09,
            'ch4_total': 5.080394321335455e-09,
            'land_mask': 10,
        ...
        'y_band': {
            'LANDMASK': 10.0,
            'OCH4_TOTAL': 1.895005697012028e-08,
            'ch4_sector_agriculture': 2.370670942157043e-11,
            ...
            'ch4_sector_oil_gas': 0.0,
            'ch4_sector_stationary': 9.684471685357763e-12,
            'ch4_sector_termite': 4.639714307197451e-11,
            'ch4_sector_transport': 1.4324859673688311e-12,
            'ch4_sector_waste': 0.0,
            'ch4_sector_wetlands': 2.288760014845792e-09,
            'ch4_total': 1.895005697012028e-08,
            'land_mask': 10,
