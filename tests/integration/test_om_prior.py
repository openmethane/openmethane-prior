...
def test_009_prior_emissions_ds(prior_emissions_ds):
    assert dataset_metrics(prior_emissions_ds) == {
        'max': {
            'LANDMASK': 1.0,
            'OCH4_TOTAL': 8.360644219903412e-09,
            'ch4_sector_agriculture': 1.4283867613607557e-12,
            ...
            'ch4_sector_livestock': 6.201040469743898e-11,
            'ch4_sector_lulucf': 1.4454168861914367e-10,
            'ch4_sector_oil_gas': 5.671488137556794e-11,
            ...
            'ch4_total': 8.360644219903412e-09,
            'lambert_conformal': 0,
            'land_mask': 1,
        ...
        'mean': {
            'LANDMASK': 1.0,
            'OCH4_TOTAL': 5.767005478563111e-10,
            'ch4_sector_agriculture': 1.1401279872307238e-12,
            ...
            'ch4_sector_livestock': 3.9170379930287976e-11,
            'ch4_sector_lulucf': 7.935998439039457e-12,
            'ch4_sector_oil_gas': 5.671488137556793e-13,
            ...
            'ch4_total': 5.767005478563111e-10,
        ...
        'x_band': {
            'LANDMASK': 10.0,
            'OCH4_TOTAL': 5.118724020185502e-09,
            'ch4_sector_agriculture': 2.61893852221542e-11,
            'ch4_sector_coal': 2.85589757264367e-09,
            'ch4_sector_electricity': 0.0,
            'ch4_sector_fire': 0.0,
            'ch4_sector_industrial': 9.990360612431248e-13,
            'ch4_sector_livestock': 8.155067771071957e-10,
            ...
            'ch4_sector_wetlands': 1.3007149871069323e-09,
            'ch4_total': 5.118724020185502e-09,
            'land_mask': 10,
        ...
        'y_band': {
            'LANDMASK': 10.0,
            'OCH4_TOTAL': 1.949238884650836e-08,
            'ch4_sector_agriculture': 2.5359888331821807e-11,
            'ch4_sector_coal': 1.6145965183918805e-08,
            'ch4_sector_electricity': 0.0,
            'ch4_sector_fire': 0.0,
            'ch4_sector_industrial': 3.7006265826194363e-13,
            'ch4_sector_livestock': 9.74821734133699e-10,
            ...
            'ch4_sector_waste': 0.0,
            'ch4_sector_wetlands': 2.2887601258680945e-09,
            'ch4_total': 1.949238884650836e-08,
            'land_mask': 10,
