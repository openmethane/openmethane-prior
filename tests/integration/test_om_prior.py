...
def test_009_prior_emissions_ds(prior_emissions_ds):
    assert dataset_metrics(prior_emissions_ds) == {
        'max': {
            'LANDMASK': 1.0,
            'OCH4_TOTAL': 1.3572649472123647e-08,
            'ch4_sector_agriculture': 2.3277985923203306e-12,
            'ch4_sector_coal': 1.3467229766109225e-08,
            ...
            'ch4_total': 1.3572649472123647e-08,
            'lambert_conformal': 0,
            'land_mask': 1,
        ...
        'mean': {
            'LANDMASK': 1.0,
            'OCH4_TOTAL': 6.102049399521322e-10,
            'ch4_sector_agriculture': 1.8375328756935794e-12,
            'ch4_sector_coal': 4.250515218652202e-10,
            ...
            'ch4_total': 6.102049399521322e-10,
        ...
        'x_band': {
            'LANDMASK': 10.0,
            'OCH4_TOTAL': 2.3336199335565213e-09,
            ...
            'ch4_total': 2.3336199335565213e-09,
            'land_mask': 10,
        ...
        'y_band': {
            'LANDMASK': 10.0,
            'OCH4_TOTAL': 1.629799852568423e-08,
            'ch4_sector_agriculture': 4.089383399587878e-11,
            'ch4_sector_coal': 1.2910974623596018e-08,
            'ch4_sector_electricity': 0.0,
            'ch4_sector_fire': 0.0,
            ...
            'ch4_total': 1.629799852568423e-08,
            'land_mask': 10,
