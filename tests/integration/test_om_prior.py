...
def test_009_prior_emissions_ds(prior_emissions_ds):
    assert dataset_metrics(prior_emissions_ds) == {
        ...
        'mean': {
            'LANDMASK': 1.0,
            'OCH4_TOTAL': 5.774233466029838e-10,
            ...
            'ch4_total': 5.774233466029838e-10,
        ...
        'x_band': {
            'LANDMASK': 10.0,
            'OCH4_TOTAL': 5.182458630825016e-09,
            ...
            'ch4_total': 5.182458630825016e-09,
            'land_mask': 10,
        ...
        'y_band': {
            'LANDMASK': 10.0,
            'OCH4_TOTAL': 1.9518806383414144e-08,
            ...
            'ch4_total': 1.9518806383414144e-08,
            'land_mask': 10,
