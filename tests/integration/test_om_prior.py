...
def test_009_prior_emissions_ds(prior_emissions_ds):
    assert dataset_metrics(prior_emissions_ds) == {
        'max': {
            'LANDMASK': 1.0,
            'OCH4_TOTAL': 7.994306174589525e-09,
            'ch4_sector_agriculture': 2.301482952605636e-12,
            ...
            'ch4_sector_lulucf': 1.357802121359527e-10,
            'ch4_sector_oil_gas': 0.0,
            'ch4_sector_stationary': 8.699782306021957e-12,
            'ch4_sector_termite': 3.3858020553889645e-12,
            'ch4_sector_transport': 2.0284102459216534e-12,
            'ch4_sector_waste': 3.5759446442430985e-12,
            'ch4_sector_wetlands': 2.5512281176531815e-10,
            'ch4_total': 7.994306174589525e-09,
            'lambert_conformal': 0,
            'land_mask': 1,
        ...
        'mean': {
            'LANDMASK': 1.0,
            'OCH4_TOTAL': 5.596221615074759e-10,
            'ch4_sector_agriculture': 1.8370270555436552e-12,
            ...
            'ch4_sector_lulucf': 7.454953389970647e-12,
            'ch4_sector_oil_gas': 0.0,
            'ch4_sector_stationary': 8.688961681263225e-13,
            'ch4_sector_termite': 2.436579367090519e-12,
            'ch4_sector_transport': 2.0258873476058302e-13,
            'ch4_sector_waste': 5.922657121199834e-14,
            'ch4_sector_wetlands': 1.2524275273123607e-10,
            'ch4_total': 5.596221615074759e-10,
        ...
        'x_band': {
            'LANDMASK': 10.0,
            'OCH4_TOTAL': 5.062426834546506e-09,
            'ch4_sector_agriculture': 4.219755129247297e-11,
            ...
            'ch4_sector_lulucf': 4.0565042629828194e-11,
            'ch4_sector_oil_gas': 0.0,
            'ch4_sector_stationary': 1.6241757762859403e-11,
            'ch4_sector_termite': 4.730782432460501e-11,
            'ch4_sector_transport': 3.786870372050251e-12,
            'ch4_sector_waste': 0.0,
            'ch4_sector_wetlands': 1.3007149732291445e-09,
            'ch4_total': 5.062426834546506e-09,
            'land_mask': 10,
        ...
        'y_band': {
            'LANDMASK': 10.0,
            'OCH4_TOTAL': 1.8817550194008247e-08,
            'ch4_sector_agriculture': 4.086102745734536e-11,
            ...
            'ch4_sector_oil_gas': 0.0,
            'ch4_sector_stationary': 6.016267365855981e-12,
            'ch4_sector_termite': 4.639714307197451e-11,
            'ch4_sector_transport': 1.4027314635975609e-12,
            'ch4_sector_waste': 0.0,
            'ch4_sector_wetlands': 2.288760014845792e-09,
            'ch4_total': 1.8817550194008247e-08,
            'land_mask': 10,
