...
def test_009_prior_emissions_ds(prior_emissions_ds):
    assert dataset_metrics(prior_emissions_ds) == {
        'max': {
            'LANDMASK': 1.0,
            'OCH4_TOTAL': 8.352448105492377e-09,
            ...
            'ch4_total': 8.352448105492377e-09,
            'lambert_conformal': 0,
            'land_mask': 1,
        ...
        'mean': {
            'LANDMASK': 1.0,
            'OCH4_TOTAL': 5.779904932204169e-10,
            ...
            'ch4_total': 5.779904932204169e-10,
        ...
        'x_band': {
            'LANDMASK': 10.0,
            'OCH4_TOTAL': 5.182458643835442e-09,
            ...
            'ch4_total': 5.182458643835442e-09,
            'land_mask': 10,
        ...
        'y_band': {
            'LANDMASK': 10.0,
            'OCH4_TOTAL': 1.951880649183436e-08,
            ...
            'ch4_total': 1.951880649183436e-08,
            'land_mask': 10,
