...
def test_009_prior_emissions_ds(prior_emissions_ds):
    assert dataset_metrics(prior_emissions_ds) == {
        'max': {
            'LANDMASK': 1.0,
            'OCH4_TOTAL': 8.106117813513568e-09,
            ...
            'ch4_sector_wetlands': 9.336642681185954e-13,
            'ch4_total': 8.106117813513568e-09,
            'lambert_conformal': 0,
            'land_mask': 1,
        ...
        'mean': {
            'LANDMASK': 1.0,
            'OCH4_TOTAL': 4.522672754052347e-10,
            ...
            'ch4_sector_wetlands': 8.668152860809177e-14,
            'ch4_total': 4.522672754052347e-10,
        ...
        'x_band': {
            'LANDMASK': 10.0,
            'OCH4_TOTAL': 3.882923352915691e-09,
            ...
            'ch4_sector_wetlands': 1.179696620862512e-12,
            'ch4_total': 3.882923352915691e-09,
            'land_mask': 10,
        ...
        'y_band': {
            'LANDMASK': 10.0,
            'OCH4_TOTAL': 1.7230827816605878e-08,
            ...
            'ch4_sector_waste': 0.0,
            'ch4_sector_wetlands': 7.814476038461391e-13,
            'ch4_total': 1.7230827816605878e-08,
            'land_mask': 10,
