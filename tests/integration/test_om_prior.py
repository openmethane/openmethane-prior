...
def test_009_prior_emissions_ds(prior_emissions_ds):
    assert dataset_metrics(prior_emissions_ds) == {
        'max': {
            'LANDMASK': 1.0,
            'OCH4_TOTAL': 8.107497215625591e-09,
            ...
            'ch4_sector_wetlands': 3.1696403314518395e-12,
            'ch4_total': 8.107497215625591e-09,
            'lambert_conformal': 0,
            'land_mask': 1,
        ...
        'mean': {
            'LANDMASK': 1.0,
            'OCH4_TOTAL': 4.5271840290808e-10,
            ...
            'ch4_sector_wetlands': 5.378090314535063e-13,
            'ch4_total': 4.5271840290808e-10,
        ...
        'x_band': {
            'LANDMASK': 10.0,
            'OCH4_TOTAL': 3.883111083097958e-09,
            ...
            'ch4_sector_wetlands': 1.3674268031292163e-12,
            'ch4_total': 3.883111083097958e-09,
            'land_mask': 10,
        ...
        'y_band': {
            'LANDMASK': 10.0,
            'OCH4_TOTAL': 1.724086059545592e-08,
            ...
            'ch4_sector_waste': 0.0,
            'ch4_sector_wetlands': 1.0814226453887375e-11,
            'ch4_total': 1.724086059545592e-08,
            'land_mask': 10,
