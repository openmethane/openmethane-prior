...
def test_01_prior_emissions_ds(prior_emissions_ds):
    assert dataset_metrics(prior_emissions_ds) == {
        'max': {
            'LANDMASK': 1.0,
            'OCH4_TOTAL': 8.106117813512767e-09,
            ...
            'ch4_total': 8.106117813512767e-09,
            'lambert_conformal': 0,
            'land_mask': 1,
        ...
        'mean': {
            'LANDMASK': 1.0,
            'OCH4_TOTAL': 4.522672753540878e-10,
            ...
            'ch4_total': 4.522672753540878e-10,
        ...
        'x_band': {
            'LANDMASK': 10.0,
            'OCH4_TOTAL': 3.882923353318124e-09,
            ...
            'ch4_total': 3.882923353318124e-09,
            'land_mask': 10,
        ...
        'y_band': {
            'LANDMASK': 10.0,
            'OCH4_TOTAL': 1.7230827813533157e-08,
            ...
            'ch4_total': 1.7230827813533157e-08,
            'land_mask': 10,
...
def test_02_output_dims(prior_emissions_ds):
    expected_dimensions = {
        "time": 2,
        "vertical": 1,
        "y": 10,
...
def test_03_output_variable_attributes(prior_emissions_ds):
